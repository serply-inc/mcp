...
def create_app(settings: Settings, client: SerplyClient) -> FastMCP:
    mcp = FastMCP(
        ...
        instructions=(
            "Real-time web search, Reddit, and scraping via Serply.io. "
            ...
            "amazon_product_search, reddit_subreddit_posts, reddit_subreddit_about, "
            "reddit_user_posts, reddit_post, reddit_post_comments, scrape_url."
        ),
